      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Link href="https://github.com/rishavmehra/rustyq" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
        ...
        <div className="navbar-end">
          ...
          <label
              ...
              <div className={`h-0.5 w-8 bg-gray-600 ${isNavOpen ? 'hidden' : ''}`} />
              <div className={`h-0.5 w-8 bg-gray-600 ${isNavOpen ? 'hidden' : ''}`} />
              <div className={`h-0.5 w-8 bg-gray-600 ${isNavOpen ? 'hidden' : ''}`} />
            </div>
            <div className={`absolute block h-0.5 w-8 animate-pulse bg-gray-600 ${isNavOpen ? "" : "hidden"}`}
